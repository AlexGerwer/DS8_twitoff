"""Predicts which user is more likely to have tweeted a give text"""
import pickle
import numpy as np
...
def predict_user(user1_name, user2_name, tweet_text, cache=None):
    """Predict which user is more likely to tweet a phrase and return result"""
    ...
    if cache and cache.exists(user_set):
        ...
        # Embed the tweets of those users
